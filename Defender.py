...
black_bg = pygame.transform.scale(pygame.image.load(os.path.join("assets", "background-black.png")), (WIDTH, HEIGHT))
title_bg = pygame.transform.scale(pygame.image.load(os.path.join("assets", "background-title.png")), (WIDTH, HEIGHT))
snow_bg = pygame.transform.scale(pygame.image.load(os.path.join("assets", "background-snow.png")), (WIDTH, HEIGHT))
mud_bg = pygame.transform.scale(pygame.image.load(os.path.join("assets", "background-mud.png")), (WIDTH, HEIGHT))
field_bg = pygame.transform.scale(pygame.image.load(os.path.join("assets", "background-field.png")), (WIDTH, HEIGHT))
victory_bg = pygame.transform.scale(pygame.image.load(os.path.join("assets", "victory_bg.png")), (WIDTH, HEIGHT))
